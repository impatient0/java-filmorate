...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> handleInternalServerException(final InternalServerException e) {
        log.warn("Encountered {}: returning 500 Internal Server Error. Message: {}",
                e.getClass().getSimpleName(), e.getMessage());
        ErrorMessage errorMessage = new ErrorMessage("Internal server error.", e.getMessage());
    ...
    public ResponseEntity<ErrorMessage> handleMethodArgumentTypeMismatchException(
        ...
        String requiredType = e.getRequiredType() == null ? "null" : e.getRequiredType().getSimpleName();
